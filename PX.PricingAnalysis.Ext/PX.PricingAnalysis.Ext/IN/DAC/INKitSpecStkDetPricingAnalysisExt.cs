...
namespace PX.PricingAnalysis.Ext
{
    public sealed class INKitSpecStkDetPricingAnalysisExt : PXCacheExtension<INKitSpecStkDet>
	{
		...
		[PXPriceCost()]
		[PXUnboundDefault(TypeCode.Decimal, "0.0", typeof(Search<InventoryItemCurySettings.basePrice, Where<InventoryItemCurySettings.inventoryID, Equal<Current<INKitSpecStkDet.compInventoryID>>, And<InventoryItemCurySettings.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>))]
		...
		[PXFormula(typeof(Mult<usrUnitPrice, INKitSpecStkDet.dfltCompQty>))]
