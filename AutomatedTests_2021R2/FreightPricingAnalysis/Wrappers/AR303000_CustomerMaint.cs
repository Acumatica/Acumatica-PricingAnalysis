...
namespace GeneratedWrappers.Acumatica
{
    ...
    public class AR303000_CustomerMaint : Wrapper
    {
        ...
        protected c_locations_grdlocations Locations_grdLocations { get; } = new c_locations_grdlocations("ctl00_phG_tab_t5_grdLocations", "Locations_grdLocations");
        protected c_locations_lv0 Locations_lv0 { get; } = new c_locations_lv0("ctl00_phG_tab_t5_grdLocations_lv0", "Locations_lv0");
        ...
        protected c_currentcustomer_deflocation CurrentCustomer_DefLocation { get; } = new c_currentcustomer_deflocation("ctl00_phG_tab_t3_DefLocation", "CurrentCustomer_DefLocation");
        protected c_deflocation_deflocationaccount DefLocation_DefLocationAccount { get; } = new c_deflocation_deflocationaccount("ctl00_phG_tab_t12_DefLocationAccount", "DefLocation_DefLocationAccount");
        protected c_deflocation_formretainage DefLocation_formRetainage { get; } = new c_deflocation_formretainage("ctl00_phG_tab_t12_formRetainage", "DefLocation_formRetainage");
        ...
        protected c_salespersons_pxgrid1 SalesPersons_PXGrid1 { get; } = new c_salespersons_pxgrid1("ctl00_phG_tab_t8_PXGrid1", "SalesPersons_PXGrid1");
        protected c_salespersons_lv0 SalesPersons_lv0 { get; } = new c_salespersons_lv0("ctl00_phG_tab_t8_PXGrid1_lv0", "SalesPersons_lv0");
        protected c_balances_pxgrid1 Balances_PXGrid1 { get; } = new c_balances_pxgrid1("ctl00_phG_tab_t4_PXGrid1", "Balances_PXGrid1");
        protected c_balances_lv0 Balances_lv0 { get; } = new c_balances_lv0("ctl00_phG_tab_t4_PXGrid1_lv0", "Balances_lv0");
        ...
        protected c_answers_pxgridanswers Answers_PXGridAnswers { get; } = new c_answers_pxgridanswers("ctl00_phG_tab_t10_PXGridAnswers", "Answers_PXGridAnswers");
        protected c_answers_lv0 Answers_lv0 { get; } = new c_answers_lv0("ctl00_phG_tab_t10_PXGridAnswers_lv0", "Answers_lv0");
        protected c_activities_activities_grid Activities_Activities_grid { get; } = new c_activities_activities_grid("ctl00_phG_tab_t11_gridActivities_Activities_grid", "Activities_Activities_grid");
        protected c_activities_lv0 Activities_lv0 { get; } = new c_activities_lv0("ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0", "Activities_lv0");
        protected c_activities_preview_activities_form Activities_Preview_Activities_form { get; } = new c_activities_preview_activities_form("ctl00_phG_tab_t11_gridActivities_Activities_form", "Activities$Preview_Activities_form");
        protected c_notificationsources_gridns NotificationSources_gridNS { get; } = new c_notificationsources_gridns("ctl00_phG_tab_t13_sp1_gridNS", "NotificationSources_gridNS");
        protected c_notificationsources_lv0 NotificationSources_lv0 { get; } = new c_notificationsources_lv0("ctl00_phG_tab_t13_sp1_gridNS_lv0", "NotificationSources_lv0");
        protected c_notificationrecipients_gridnr NotificationRecipients_gridNR { get; } = new c_notificationrecipients_gridnr("ctl00_phG_tab_t13_sp1_gridNR", "NotificationRecipients_gridNR");
        protected c_notificationrecipients_lv0 NotificationRecipients_lv0 { get; } = new c_notificationrecipients_lv0("ctl00_phG_tab_t13_sp1_gridNR_lv0", "NotificationRecipients_lv0");
        ...
        protected c_childaccounts_gridchildaccounts ChildAccounts_gridChildAccounts { get; } = new c_childaccounts_gridchildaccounts("ctl00_phG_tab_t9_gridChildAccounts", "ChildAccounts_gridChildAccounts");
        protected c_childaccounts_lv0 ChildAccounts_lv0 { get; } = new c_childaccounts_lv0("ctl00_phG_tab_t9_gridChildAccounts_lv0", "ChildAccounts_lv0");
        ...
        protected c_paymentmethods_grdpaymentmethods PaymentMethods_grdPaymentMethods { get; } = new c_paymentmethods_grdpaymentmethods("ctl00_phG_tab_t6_grdPaymentMethods", "PaymentMethods_grdPaymentMethods");
        protected c_paymentmethods_lv0 PaymentMethods_lv0 { get; } = new c_paymentmethods_lv0("ctl00_phG_tab_t6_grdPaymentMethods_lv0", "PaymentMethods_lv0");
        ...
        protected c_compliancedocuments_grdcompliancedocuments ComplianceDocuments_grdComplianceDocuments { get; } = new c_compliancedocuments_grdcompliancedocuments("ctl00_phG_tab_t15_grdComplianceDocuments", "ComplianceDocuments_grdComplianceDocuments");
        protected c_compliancedocuments_lv0 ComplianceDocuments_lv0 { get; } = new c_compliancedocuments_lv0("ctl00_phG_tab_t15_grdComplianceDocuments_lv0", "ComplianceDocuments_lv0");
        protected c_customerbillingcycles_gridbillingcycles CustomerBillingCycles_gridBillingCycles { get; } = new c_customerbillingcycles_gridbillingcycles("ctl00_phG_tab_t14_gridBillingCycles", "CustomerBillingCycles_gridBillingCycles");
        ...
        public virtual void RegenerateLastStatement(bool status, string message = null)
        {
            ToolBar.RegenerateLastStatement.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.RegenerateLastStatement.Click();
        }
        ...
        public virtual void CustomerManagementID()
        {
            ToolBar.CustomerManagementID.Click();
        }
        
        public virtual void DocumentProcessingID()
        {
            ToolBar.DocumentProcessingID.Click();
        }
        
        public virtual void StatementsID()
        {
            ToolBar.StatementsID.Click();
        }
        
        public virtual void ServicesID()
        {
            ToolBar.ServicesID.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton CustomerManagementID { get; }
			public ToolBarButton DocumentProcessingID { get; }
			public ToolBarButton StatementsID { get; }
			public ToolBarButton ServicesID { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                Delete.ConfirmAction = () => Alert.AlertToException("The current Customer record will be deleted.");
                ...
                NewInvoiceMemo = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_NewInvoiceMemo,#ctl00_phDS_ds_ToolBar_NewInvoiceMemo_i" +
                        "tem", "Create Invoice", locator, MenuOpener);
                NewSalesOrder = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_NewSalesOrder,#ctl00_phDS_ds_ToolBar_NewSalesOrder_ite" +
                        "m", "Create Sales Order", locator, MenuOpener);
                NewPayment = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_NewPayment,#ctl00_phDS_ds_ToolBar_NewPayment_item", "Create Payment", locator, MenuOpener);
                WriteOffBalance = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_WriteOffBalance,#ctl00_phDS_ds_ToolBar_WriteOffBalance" +
                        "_item", "Write Off Balance", locator, MenuOpener);
                GenerateOnDemandStatement = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_GenerateOnDemandStatement,#ctl00_phDS_ds_ToolBar_Gener" +
                        "ateOnDemandStatement_item", "Generate on Demand", locator, MenuOpener);
                RegenerateLastStatement = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_RegenerateLastStatement,#ctl00_phDS_ds_ToolBar_Regener" +
                        "ateLastStatement_item", "Regenerate Last Statement", locator, MenuOpener);
                RegenerateLastStatement.WaitAction = Wait.WaitForLongOperationToComplete;
                ...
                StatementForCustomer = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_StatementForCustomer,#ctl00_phDS_ds_ToolBar_StatementF" +
                        "orCustomer_item", "Statement History", locator, MenuOpener);
                SalesPrice = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_SalesPrice,#ctl00_phDS_ds_ToolBar_SalesPrice_item", "Sales Prices", locator, MenuOpener);
                ARBalanceByCustomer = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_ARBalanceByCustomer,#ctl00_phDS_ds_ToolBar_ARBalanceBy" +
                        "Customer_item", "AR Balance by Customer", locator, MenuOpener);
                ARRegister = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_ARRegister,#ctl00_phDS_ds_ToolBar_ARRegister_item", "AR Register", locator, MenuOpener);
                CustomerHistory = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CustomerHistory,#ctl00_phDS_ds_ToolBar_CustomerHistory" +
                        "_item", "Customer History", locator, MenuOpener);
                ARAgedPastDue = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_ARAgedPastDue,#ctl00_phDS_ds_ToolBar_ARAgedPastDue_ite" +
                        "m", "AR Aging", locator, MenuOpener);
                ARAgedOutstanding = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_ARAgedOutstanding,#ctl00_phDS_ds_ToolBar_ARAgedOutstan" +
                        "ding_item", "AR Coming Due", locator, MenuOpener);
                CustomerDetails = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CustomerDetails,#ctl00_phDS_ds_ToolBar_CustomerDetails" +
                        "_item", "Customer Profile", locator, MenuOpener);
                CustomerStatement = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CustomerStatement,#ctl00_phDS_ds_ToolBar_CustomerState" +
                        "ment_item", "Print Statement", locator, MenuOpener);
                ...
                CustomerManagementID = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CustomerManagementID", "Customer Management", locator, MenuOpener);
                DocumentProcessingID = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_DocumentProcessingID", "Document Processing", locator, MenuOpener);
                StatementsID = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_StatementsID", "Statements", locator, MenuOpener);
                ServicesID = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_ServicesID", "Services", locator, MenuOpener);
                ...
                NewContact = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_NewContact,#ctl00_phDS_ds_ToolBar_NewContact_item", "Add Contact", locator, MenuOpener);
        ...
        public class c_baccount_baccount : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                Status = new DropDown("ctl00_phF_BAccount_t0_edStatus", "Customer Status", locator, null);
        ...
        public class c_currentcustomer_tab : Container
        {
			...
			public PXTextEdit SmallBalanceLimit_Label { get; }
			public Label SmallBalanceLimit_LabelLabel { get; }
			...
			public PXTextEdit CreditLimit_Label { get; }
			public Label CreditLimit_LabelLabel { get; }
                    ...
                    base(locator, name)
            {
                ...
                SmallBalanceLimit_Label = new PXTextEdit("ctl00_phG_tab_t1_edSmallBalanceLimitLabel", "Small Balance Limit _ Label", locator, null);
                SmallBalanceLimit_LabelLabel = new Label(SmallBalanceLimit_Label);
                SmallBalanceLimit_Label.DataField = "SmallBalanceLimit_Label";
                SmallBalanceLimit = new PXNumberEdit("ctl00_phG_tab_t1_edSmallBalanceLimit", "Small Balance Limit", locator, null);
                ...
                CreditLimit_Label = new PXTextEdit("ctl00_phG_tab_t1_edCreditLimitLabel", "Credit Limit _ Label", locator, null);
                CreditLimit_LabelLabel = new Label(CreditLimit_Label);
                CreditLimit_Label.DataField = "CreditLimit_Label";
                ...
                DiscTakenAcctID = new Selector("ctl00_phG_tab_t12_edDiscTakenAcctID", "Cash Discount Account", locator, null);
                DiscTakenAcctIDLabel = new Label(DiscTakenAcctID);
                DiscTakenAcctID.DataField = "DiscTakenAcctID";
                DiscTakenSubID = new Selector("ctl00_phG_tab_t12_edDiscTakenSubID", "Cash Discount Sub.", locator, null);
                DiscTakenSubIDLabel = new Label(DiscTakenSubID);
                DiscTakenSubID.DataField = "DiscTakenSubID";
                PrepaymentAcctID = new Selector("ctl00_phG_tab_t12_edPrepaymentAcctID", "Prepayment Account", locator, null);
                PrepaymentAcctIDLabel = new Label(PrepaymentAcctID);
                PrepaymentAcctID.DataField = "PrepaymentAcctID";
                PrepaymentSubID = new Selector("ctl00_phG_tab_t12_edPrepaymentSubID", "Prepayment Sub.", locator, null);
			...
			public Button COGSSubIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    StatementCycleIdEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    BillingCycleIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    ParentBAccountIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    DiscTakenSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_edDiscTakenSubID\'] div[class=\'editBtnCont\'] > div >" +
                            " div", "DiscTakenSubIDEdit", "ctl00_phG_tab");
                    DiscTakenSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    PrepaymentSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_edPrepaymentSubID\'] div[class=\'editBtnCont\'] > div " +
                            "> div", "PrepaymentSubIDEdit", "ctl00_phG_tab");
                    PrepaymentSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    COGSSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_edCOGSSubID\'] div[class=\'editBtnCont\'] > div > div", "COGSSubIDEdit", "ctl00_phG_tab");
                    COGSSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_locations_grdlocations : Grid<c_locations_grdlocations.c_grid_row, c_locations_grdlocations.c_grid_header>
        {
            ...
            public c_locations_grdlocations(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t5_grdLocations");
                DataMemberName = "Locations";
                PredefinedFilter = new DropDown("ctl00_phG_tab_t5_grdLocations_at_tlb_fs", "Predefined Filter", locator, null);
                PredefinedFilter.Items.Add("00000000-0000-0000-0000-000000000000", "All Records");
                QuickSearch = new QuickSearch("ctl00_phG_tab_t5_grdLocations_at_tlb_fb", "QuickSearch", locator, null);
                FilterForm = new c_grid_filter("ctl00_phG_tab_t5_grdLocations_fe_gf", "FilterForm");
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    NewLocation = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'NewLocation\']", "Add New Location", locator, null);
                    LocationDetails = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'cmdViewLocation\']", "Location Details", locator, null);
                    SetDefaultLocation = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'SetDefaultLocation\']", "Set as Default", locator, null);
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Filter = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'FilterShow\']", "Filter Settings", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t5_grdLocations_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public PXNumberEdit BAccountID { get; }
                        ...
                        base(grid)
                {
                    ...
                    IsActive = new CheckBox("ctl00_phG_tab_t5_grdLocations_ef", "Active", grid.Locator, "IsActive");
                    IsActive.DataField = "IsActive";
                    LocationCD = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Location ID", grid.Locator, "LocationCD");
                    LocationCD.DataField = "LocationCD";
                    Descr = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Location Name", grid.Locator, "Descr");
                    Descr.DataField = "Descr";
                    IsDefault = new CheckBox("ctl00_phG_tab_t5_grdLocations", "Default", grid.Locator, "IsDefault");
                    IsDefault.DataField = "IsDefault";
                    Address__City = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "City", grid.Locator, "Address__City");
                    Address__City.DataField = "Address__City";
                    Address__State = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "State", grid.Locator, "Address__State");
                    Address__State.DataField = "Address__State";
                    Address__CountryID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Country", grid.Locator, "Address__CountryID");
                    Address__CountryID.DataField = "Address__CountryID";
                    Address__PostalCode = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Postal Code", grid.Locator, "Address__PostalCode");
                    Address__PostalCode.DataField = "Address__PostalCode";
                    Address__State_description = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "State Name", grid.Locator, "Address__State_description");
                    Address__State_description.DataField = "Address__State_description";
                    Address__CountryID_description = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Country Name", grid.Locator, "Address__CountryID_description");
                    Address__CountryID_description.DataField = "Address__CountryID_description";
                    CPriceClassID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Price Class", grid.Locator, "CPriceClassID");
                    CPriceClassID.DataField = "CPriceClassID";
                    CreatedByID_Description = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Created By", grid.Locator, "CreatedByID_Description");
                    CreatedByID_Description.DataField = "CreatedByID_Description";
                    CreatedDateTime = new DateSelector("_ctl00_phG_tab_t5_grdLocations_lv0_ed14", "CreatedDateTime", grid.Locator, "CreatedDateTime");
                    CreatedDateTime.DataField = "CreatedDateTime";
                    LastModifiedByID_Description = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Last Modified By", grid.Locator, "LastModifiedByID_Description");
                    LastModifiedByID_Description.DataField = "LastModifiedByID_Description";
                    LastModifiedDateTime = new DateSelector("_ctl00_phG_tab_t5_grdLocations_lv0_ed16", "LastModifiedDateTime", grid.Locator, "LastModifiedDateTime");
                    LastModifiedDateTime.DataField = "LastModifiedDateTime";
                    CDefProjectID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Default Project", grid.Locator, "CDefProjectID");
                    CDefProjectID.DataField = "CDefProjectID";
                    TaxRegistrationID = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Tax Registration ID", grid.Locator, "TaxRegistrationID");
                    TaxRegistrationID.DataField = "TaxRegistrationID";
                    CTaxZoneID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Tax Zone", grid.Locator, "CTaxZoneID");
                    CTaxZoneID.DataField = "CTaxZoneID";
                    CTaxCalcMode = new DropDown("_ctl00_phG_tab_t5_grdLocations_lv0_ec", "Tax Calculation Mode", grid.Locator, "CTaxCalcMode");
                    ...
                    CAvalaraExemptionNumber = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Tax Exemption Number", grid.Locator, "CAvalaraExemptionNumber");
                    CAvalaraExemptionNumber.DataField = "CAvalaraExemptionNumber";
                    CAvalaraCustomerUsageType = new DropDown("_ctl00_phG_tab_t5_grdLocations_lv0_ec", "Entity Usage Type", grid.Locator, "CAvalaraCustomerUsageType");
                    ...
                    CSiteID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Warehouse", grid.Locator, "CSiteID");
                    CSiteID.DataField = "CSiteID";
                    CCarrierID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Ship Via", grid.Locator, "CCarrierID");
                    CCarrierID.DataField = "CCarrierID";
                    CShipTermsID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Shipping Terms", grid.Locator, "CShipTermsID");
                    CShipTermsID.DataField = "CShipTermsID";
                    CShipZoneID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Shipping Zone", grid.Locator, "CShipZoneID");
                    CShipZoneID.DataField = "CShipZoneID";
                    CFOBPointID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "FOB Point", grid.Locator, "CFOBPointID");
                    CFOBPointID.DataField = "CFOBPointID";
                    CResedential = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ef", "Residential Delivery", grid.Locator, "CResedential");
                    CResedential.DataField = "CResedential";
                    CSaturdayDelivery = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ef", "Saturday Delivery", grid.Locator, "CSaturdayDelivery");
                    CSaturdayDelivery.DataField = "CSaturdayDelivery";
                    CInsurance = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ef", "Insurance", grid.Locator, "CInsurance");
                    CInsurance.DataField = "CInsurance";
                    CShipComplete = new DropDown("_ctl00_phG_tab_t5_grdLocations_lv0_ec", "Shipping Rule", grid.Locator, "CShipComplete");
                    ...
                    COrderPriority = new PXNumberEdit("ctl00_phG_tab_t5_grdLocations_en", "Order Priority", grid.Locator, "COrderPriority");
                    COrderPriority.DataField = "COrderPriority";
                    CLeadTime = new PXNumberEdit("ctl00_phG_tab_t5_grdLocations_en", "Lead Time (Days)", grid.Locator, "CLeadTime");
                    CLeadTime.DataField = "CLeadTime";
                    CCalendarID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Calendar", grid.Locator, "CCalendarID");
                    CCalendarID.DataField = "CCalendarID";
                    CSalesAcctID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Sales Account", grid.Locator, "CSalesAcctID");
                    CSalesAcctID.DataField = "CSalesAcctID";
                    CSalesSubID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Sales Sub.", grid.Locator, "CSalesSubID");
                    CSalesSubID.DataField = "CSalesSubID";
                    CARAccountID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "AR Account", grid.Locator, "CARAccountID");
                    CARAccountID.DataField = "CARAccountID";
                    CARSubID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "AR Sub.", grid.Locator, "CARSubID");
                    CARSubID.DataField = "CARSubID";
                    CDiscountAcctID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Discount Account", grid.Locator, "CDiscountAcctID");
                    CDiscountAcctID.DataField = "CDiscountAcctID";
                    CDiscountSubID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Discount Sub.", grid.Locator, "CDiscountSubID");
                    CDiscountSubID.DataField = "CDiscountSubID";
                    CFreightAcctID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Freight Account", grid.Locator, "CFreightAcctID");
                    CFreightAcctID.DataField = "CFreightAcctID";
                    CFreightSubID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Freight Sub.", grid.Locator, "CFreightSubID");
                    CFreightSubID.DataField = "CFreightSubID";
                    CBranchID = new Selector("_ctl00_phG_tab_t5_grdLocations_lv0_es", "Default Branch", grid.Locator, "CBranchID");
                    CBranchID.DataField = "CBranchID";
                    CBranchID_description = new PXTextEdit("ctl00_phG_tab_t5_grdLocations_ei", "Branch Name", grid.Locator, "CBranchID_description");
                    CBranchID_description.DataField = "CBranchID_description";
                    BAccountID = new PXNumberEdit("ctl00_phG_tab_t5_grdLocations_en", "BAccountID", grid.Locator, "BAccountID");
        ...
        public class c_locations_lv0 : Container
        {
            ...
            public c_locations_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Es = new Selector("ctl00_phG_tab_t5_grdLocations_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_tab_t5_grdLocations_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Ec = new DropDown("ctl00_phG_tab_t5_grdLocations_lv0_ec", "Ec", locator, null);
                Em = new Selector("ctl00_phG_tab_t5_grdLocations_lv0_em", "Em", locator, null);
        ...
        public class c_deflocation_deflocation : Container
        {
			...
			public Button Last { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    CBranchIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CPriceClassIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CDefProjectIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CTaxZoneIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CSiteIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CCarrierIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CShipTermsIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CShipZoneIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    ...
                    CFOBPointIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
        ...
        public class c_currentcustomer_deflocation : Container
        {
            
			public CheckBox SuggestRelatedItems { get; }
			public Label SuggestRelatedItemsLabel { get; }
            
            public c_currentcustomer_deflocation(string locator, string name) : 
                    base(locator, name)
            {
                SuggestRelatedItems = new CheckBox("ctl00_phG_tab_t3_DefLocation_chkSuggestRelatedItems", "Suggest Related Items", locator, null);
                SuggestRelatedItemsLabel = new Label(SuggestRelatedItems);
                SuggestRelatedItems.DataField = "SuggestRelatedItems";
                DataMemberName = "CurrentCustomer";
            }
        }
        ...
        public class c_deflocation_deflocationaccount : Container
        {
            ...
            public c_deflocation_deflocationaccount(string locator, string name) : 
                    base(locator, name)
            {
                CARAccountID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCARAccountID", "AR Account", locator, null);
                CARAccountIDLabel = new Label(CARAccountID);
                CARAccountID.DataField = "CARAccountID";
                CARSubID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCARSubID", "AR Sub.", locator, null);
                CARSubIDLabel = new Label(CARSubID);
                CARSubID.DataField = "CARSubID";
                CSalesAcctID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCSalesAcctID", "Sales Account", locator, null);
                CSalesAcctIDLabel = new Label(CSalesAcctID);
                CSalesAcctID.DataField = "CSalesAcctID";
                CSalesSubID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCSalesSubID", "Sales Sub.", locator, null);
                CSalesSubIDLabel = new Label(CSalesSubID);
                CSalesSubID.DataField = "CSalesSubID";
                CDiscountAcctID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCDiscountAcctID", "Discount Account", locator, null);
                CDiscountAcctIDLabel = new Label(CDiscountAcctID);
                CDiscountAcctID.DataField = "CDiscountAcctID";
                CDiscountSubID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCDiscountSubID", "Discount Sub.", locator, null);
                CDiscountSubIDLabel = new Label(CDiscountSubID);
                CDiscountSubID.DataField = "CDiscountSubID";
                CFreightAcctID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCFreightAcctID", "Freight Account", locator, null);
                CFreightAcctIDLabel = new Label(CFreightAcctID);
                CFreightAcctID.DataField = "CFreightAcctID";
                CFreightSubID = new Selector("ctl00_phG_tab_t12_DefLocationAccount_edCFreightSubID", "Freight Sub.", locator, null);
			...
			public Button CFreightSubIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    CARSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_DefLocationAccount_edCARSubID\'] div[class=\'editBtnC" +
                            "ont\'] > div > div", "CARSubIDEdit", "ctl00_phG_tab_t12_DefLocationAccount");
                    CARSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    CSalesSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_DefLocationAccount_edCSalesSubID\'] div[class=\'editB" +
                            "tnCont\'] > div > div", "CSalesSubIDEdit", "ctl00_phG_tab_t12_DefLocationAccount");
                    CSalesSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    CDiscountSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_DefLocationAccount_edCDiscountSubID\'] div[class=\'ed" +
                            "itBtnCont\'] > div > div", "CDiscountSubIDEdit", "ctl00_phG_tab_t12_DefLocationAccount");
                    CDiscountSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    CFreightSubIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t12_DefLocationAccount_edCFreightSubID\'] div[class=\'edi" +
                            "tBtnCont\'] > div > div", "CFreightSubIDEdit", "ctl00_phG_tab_t12_DefLocationAccount");
                    CFreightSubIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_deflocation_formretainage : Container
        {
            ...
            public c_deflocation_formretainage(string locator, string name) : 
                    base(locator, name)
            {
                CRetainageAcctID = new Selector("ctl00_phG_tab_t12_formRetainage_edCRetainageAcctID", "Retainage Receivable Account", locator, null);
                CRetainageAcctIDLabel = new Label(CRetainageAcctID);
                CRetainageAcctID.DataField = "CRetainageAcctID";
                CRetainageSubID = new Selector("ctl00_phG_tab_t12_formRetainage_edCRetainageSubID", "Retainage Receivable Sub.", locator, null);
        ...
        public class c_salespersons_pxgrid1 : Grid<c_salespersons_pxgrid1.c_grid_row, c_salespersons_pxgrid1.c_grid_header>
        {
            ...
            public c_salespersons_pxgrid1(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t8_PXGrid1");
                DataMemberName = "SalesPersons";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t8_PXGrid1_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t8_PXGrid1_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public CheckBox IsDefault { get; }
                ...
                public c_grid_row(c_salespersons_pxgrid1 grid) : 
                        base(grid)
                {
                    SalesPersonID = new Selector("_ctl00_phG_tab_t8_PXGrid1_lv0_edSalesPersonID", "Salesperson ID", grid.Locator, "SalesPersonID");
                    SalesPersonID.DataField = "SalesPersonID";
                    SalesPersonID_SalesPerson_descr = new PXTextEdit("ctl00_phG_tab_t8_PXGrid1_ei", "Name", grid.Locator, "SalesPersonID_SalesPerson_descr");
                    SalesPersonID_SalesPerson_descr.DataField = "SalesPersonID_SalesPerson_descr";
                    LocationID = new Selector("_ctl00_phG_tab_t8_PXGrid1_lv0_edLocationID", "Location ID", grid.Locator, "LocationID");
                    LocationID.DataField = "LocationID";
                    LocationID_description = new PXTextEdit("_ctl00_phG_tab_t8_PXGrid1_lv0_edLocation_descr", "Location Name", grid.Locator, "LocationID_description");
                    LocationID_description.DataField = "LocationID_description";
                    CommisionPct = new PXNumberEdit("_ctl00_phG_tab_t8_PXGrid1_lv0_edCommisionPct", "Commission %", grid.Locator, "CommisionPct");
                    CommisionPct.DataField = "CommisionPct";
                    IsDefault = new CheckBox("ctl00_phG_tab_t8_PXGrid1_ef", "Default", grid.Locator, "IsDefault");
                    IsDefault.DataField = "IsDefault";
                }
            }
        ...
        public class c_salespersons_lv0 : Container
        {
            ...
            public c_salespersons_lv0(string locator, string name) : 
                    base(locator, name)
            {
                SalesPersonID = new Selector("ctl00_phG_tab_t8_PXGrid1_lv0_edSalesPersonID", "Salesperson ID", locator, null);
                SalesPersonIDLabel = new Label(SalesPersonID);
                SalesPersonID.DataField = "SalesPersonID";
                LocationID = new Selector("ctl00_phG_tab_t8_PXGrid1_lv0_edLocationID", "Location ID", locator, null);
                LocationIDLabel = new Label(LocationID);
                LocationID.DataField = "LocationID";
                LocationID_description = new PXTextEdit("ctl00_phG_tab_t8_PXGrid1_lv0_edLocation_descr", "Location Name", locator, null);
                LocationID_descriptionLabel = new Label(LocationID_description);
                LocationID_description.DataField = "LocationID_description";
                CommisionPct = new PXNumberEdit("ctl00_phG_tab_t8_PXGrid1_lv0_edCommisionPct", "Commission %", locator, null);
                CommisionPctLabel = new Label(CommisionPct);
                CommisionPct.DataField = "CommisionPct";
                Es = new Selector("ctl00_phG_tab_t8_PXGrid1_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                DataMemberName = "SalesPersons";
                Buttons = new PxButtonCollection();
            }
			...
			public Button LocationIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    SalesPersonIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t8_PXGrid1_lv0_edSalesPersonID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "SalesPersonIDEdit", "ctl00_phG_tab_t8_PXGrid1_lv0");
                    SalesPersonIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    LocationIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t8_PXGrid1_lv0_edLocationID\'] div[class=\'editBtnCont\'] " +
                            "> div > div", "LocationIDEdit", "ctl00_phG_tab_t8_PXGrid1_lv0");
                    LocationIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        
        public class c_balances_pxgrid1 : Grid<c_balances_pxgrid1.c_grid_row, c_balances_pxgrid1.c_grid_header>
        {
            ...
            public c_balances_pxgrid1(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t4_PXGrid1");
                DataMemberName = "Balances";
			...
			public PXNumberEdit CustomerID { get; }
                        ...
                        base(grid)
                {
                    ...
                    CurrentBal = new PXNumberEdit("_ctl00_phG_tab_t4_PXGrid1_lv0_edCurrentBal", "Balance", grid.Locator, "CurrentBal");
                    CurrentBal.DataField = "CurrentBal";
                    TotalPrepayments = new PXNumberEdit("_ctl00_phG_tab_t4_PXGrid1_lv0_edTotalPrepayments", "Prepayment Balance", grid.Locator, "TotalPrepayments");
                    TotalPrepayments.DataField = "TotalPrepayments";
                    ConsolidatedBalance = new PXNumberEdit("_ctl00_phG_tab_t4_PXGrid1_lv0_edConsolidatedBalance", "Consolidated Balance", grid.Locator, "ConsolidatedBalance");
                    ...
                    CustomerID = new PXNumberEdit("ctl00_phG_tab_t4_PXGrid1_en", "CustomerID", grid.Locator, "CustomerID");
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXNumberEditColumnFilter CurrentBal { get; }
				public PXNumberEditColumnFilter TotalPrepayments { get; }
				public PXNumberEditColumnFilter ConsolidatedBalance { get; }
				public PXNumberEditColumnFilter RetainageBalance { get; }
				public PXNumberEditColumnFilter CustomerID { get; }
                
                public c_grid_header(c_balances_pxgrid1 grid) : 
                        base(grid)
                {
                    BaseCuryID = new PXTextEditColumnFilter(grid.Row.BaseCuryID);
                    CurrentBal = new PXNumberEditColumnFilter(grid.Row.CurrentBal);
                    TotalPrepayments = new PXNumberEditColumnFilter(grid.Row.TotalPrepayments);
                    ConsolidatedBalance = new PXNumberEditColumnFilter(grid.Row.ConsolidatedBalance);
                    RetainageBalance = new PXNumberEditColumnFilter(grid.Row.RetainageBalance);
                    CustomerID = new PXNumberEditColumnFilter(grid.Row.CustomerID);
                }
            }
        }
        
        public class c_balances_lv0 : Container
        {
            
			public PXTextEdit BaseCuryID { get; }
			public Label BaseCuryIDLabel { get; }
			public PXNumberEdit CurrentBal { get; }
			public Label CurrentBalLabel { get; }
			public PXNumberEdit TotalPrepayments { get; }
			public Label TotalPrepaymentsLabel { get; }
			public PXNumberEdit ConsolidatedBalance { get; }
			public Label ConsolidatedBalanceLabel { get; }
			public PXNumberEdit RetainageBalance { get; }
			public Label RetainageBalanceLabel { get; }
            
            public c_balances_lv0(string locator, string name) : 
                    base(locator, name)
            {
                ...
                BaseCuryID.DataField = "BaseCuryID";
                CurrentBal = new PXNumberEdit("ctl00_phG_tab_t4_PXGrid1_lv0_edCurrentBal", "Balance", locator, null);
                CurrentBalLabel = new Label(CurrentBal);
                CurrentBal.DataField = "CurrentBal";
                TotalPrepayments = new PXNumberEdit("ctl00_phG_tab_t4_PXGrid1_lv0_edTotalPrepayments", "Prepayment Balance", locator, null);
                TotalPrepaymentsLabel = new Label(TotalPrepayments);
                TotalPrepayments.DataField = "TotalPrepayments";
                ConsolidatedBalance = new PXNumberEdit("ctl00_phG_tab_t4_PXGrid1_lv0_edConsolidatedBalance", "Consolidated Balance", locator, null);
        ...
        public class c_customerbalance_customerbalance : Container
        {
			...
			public PXTextEdit UnreleasedBalance_Label { get; }
			public Label UnreleasedBalance_LabelLabel { get; }
			public PXNumberEdit UnreleasedBalance { get; }
			public Label UnreleasedBalanceLabel { get; }
			public PXTextEdit OpenOrdersBalance_Label { get; }
			public Label OpenOrdersBalance_LabelLabel { get; }
			public PXNumberEdit OpenOrdersBalance { get; }
			public Label OpenOrdersBalanceLabel { get; }
			public PXTextEdit RemainingCreditLimit_Label { get; }
			public Label RemainingCreditLimit_LabelLabel { get; }
			...
			public PXTextEdit ConsolidatedBalance_Label { get; }
			public Label ConsolidatedBalance_LabelLabel { get; }
			public PXNumberEdit ConsolidatedBalance { get; }
			public Label ConsolidatedBalanceLabel { get; }
			public PXTextEdit SignedDepositsBalance_Label { get; }
			public Label SignedDepositsBalance_LabelLabel { get; }
            ...
            public c_customerbalance_customerbalance(string locator, string name) : 
                    base(locator, name)
            {
                UnreleasedBalance_Label = new PXTextEdit("ctl00_phG_tab_t1_CustomerBalance_edUnreleasedBalanceLabel", "Unreleased Balance _ Label", locator, null);
                UnreleasedBalance_LabelLabel = new Label(UnreleasedBalance_Label);
                UnreleasedBalance_Label.DataField = "UnreleasedBalance_Label";
                ...
                OpenOrdersBalance_Label = new PXTextEdit("ctl00_phG_tab_t1_CustomerBalance_edOpenOrdersBalanceLabel", "Open Orders Balance _ Label", locator, null);
                OpenOrdersBalance_LabelLabel = new Label(OpenOrdersBalance_Label);
                OpenOrdersBalance_Label.DataField = "OpenOrdersBalance_Label";
                ...
                RemainingCreditLimit_Label = new PXTextEdit("ctl00_phG_tab_t1_CustomerBalance_edRemainingCreditLimitLabel", "Remaining Credit Limit _ Label", locator, null);
                RemainingCreditLimit_LabelLabel = new Label(RemainingCreditLimit_Label);
                RemainingCreditLimit_Label.DataField = "RemainingCreditLimit_Label";
                ...
                Balance_Label = new PXTextEdit("ctl00_phF_BAccount_t0_CustomerBalance_edBalanceLabel", "Balance _ Label", locator, null);
                Balance_LabelLabel = new Label(Balance_Label);
                Balance_Label.DataField = "Balance_Label";
                Balance = new PXNumberEdit("ctl00_phF_BAccount_t0_CustomerBalance_edBBalance", "Balance", locator, null);
                BalanceLabel = new Label(Balance);
                Balance.DataField = "Balance";
                ConsolidatedBalance_Label = new PXTextEdit("ctl00_phF_BAccount_t0_CustomerBalance_edConsolidatedBalanceLabel", "Consolidated Balance _ Label", locator, null);
                ConsolidatedBalance_LabelLabel = new Label(ConsolidatedBalance_Label);
                ConsolidatedBalance_Label.DataField = "ConsolidatedBalance_Label";
                ...
                ConsolidatedBalanceLabel = new Label(ConsolidatedBalance);
                ConsolidatedBalance.DataField = "ConsolidatedBalance";
                SignedDepositsBalance_Label = new PXTextEdit("ctl00_phF_BAccount_t0_CustomerBalance_edSignedDepositsBalanceLabel", "Signed Deposits Balance _ Label", locator, null);
                SignedDepositsBalance_LabelLabel = new Label(SignedDepositsBalance_Label);
                SignedDepositsBalance_Label.DataField = "SignedDepositsBalance_Label";
                SignedDepositsBalance = new PXNumberEdit("ctl00_phF_BAccount_t0_CustomerBalance_edSignedDepositsBalance", "Signed Deposits Balance", locator, null);
                SignedDepositsBalanceLabel = new Label(SignedDepositsBalance);
                SignedDepositsBalance.DataField = "SignedDepositsBalance";
                RetainageBalance_Label = new PXTextEdit("ctl00_phF_BAccount_t0_CustomerBalance_edRetainageBalanceLabel", "Retainage Balance _ Label", locator, null);
                RetainageBalance_LabelLabel = new Label(RetainageBalance_Label);
                RetainageBalance_Label.DataField = "RetainageBalance_Label";
                RetainageBalance = new PXNumberEdit("ctl00_phF_BAccount_t0_CustomerBalance_edRetainageBalance", "Retainage Balance", locator, null);
                RetainageBalanceLabel = new Label(RetainageBalance);
                RetainageBalance.DataField = "RetainageBalance";
        ...
        public class c_answers_pxgridanswers : Grid<c_answers_pxgridanswers.c_grid_row, c_answers_pxgridanswers.c_grid_header>
        {
            ...
            public c_answers_pxgridanswers(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t10_PXGridAnswers");
                DataMemberName = "Answers";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t10_PXGridAnswers_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_PXGridAnswers_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public PXTextEdit RefNoteID { get; }
                ...
                public c_grid_row(c_answers_pxgridanswers grid) : 
                        base(grid)
                {
                    AttributeID = new Selector("_ctl00_phG_tab_t10_PXGridAnswers_lv0_es", "Attribute", grid.Locator, "AttributeID");
                    AttributeID.DataField = "AttributeID";
                    IsRequired = new CheckBox("ctl00_phG_tab_t10_PXGridAnswers", "Required", grid.Locator, "isRequired");
                    IsRequired.DataField = "isRequired";
                    Value = new PXTextEdit("ctl00_phG_tab_t10_PXGridAnswers_ei", "Value", grid.Locator, "Value");
                    Value.DataField = "Value";
                    RefNoteID = new PXTextEdit("ctl00_phG_tab_t10_PXGridAnswers_ei", "RefNoteID", grid.Locator, "RefNoteID");
        ...
        public class c_answers_lv0 : Container
        {
            ...
            public c_answers_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Es = new Selector("ctl00_phG_tab_t10_PXGridAnswers_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_tab_t10_PXGridAnswers_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Ec = new DropDown("ctl00_phG_tab_t10_PXGridAnswers_lv0_ec", "Ec", locator, null);
                Em = new Selector("ctl00_phG_tab_t10_PXGridAnswers_lv0_em", "Em", locator, null);
                EmLabel = new Label(Em);
                DataMemberName = "Answers";
            }
        }
        ...
        public class c_activities_activities_grid : Grid<c_activities_activities_grid.c_grid_row, c_activities_activities_grid.c_grid_header>
        {
            ...
            public c_activities_activities_grid(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t11_gridActivities_Activities_grid");
                DataMemberName = "Activities";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t11_gridActivities_Activities_grid_fe_gf", "FilterForm");
                FilesUploadDialog = new SmartPanel_AttachFile(locator);
                NotePanel = new Note(locator);
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'Refres" +
                            "h\']", "Refresh", locator, null);
                    CreateTask = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'cmdAdd" +
                            "Task\']", "Create Task", locator, null);
                    CreateEvent = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'cmdAdd" +
                            "Event\']", "Create Event", locator, null);
                    CreateEmail = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'cmdAdd" +
                            "Email\']", "Create Email", locator, null);
                    CreateActivity = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'cmdAdd" +
                            "Activity\']", "Create Activity", locator, null);
                    NewActivityN = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityN\']", "Create Note", locator, CreateActivity);
                    NewActivityC = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityC\']", "Create Chat", locator, CreateActivity);
                    NewActivityE = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityE\']", "Create Appointment", locator, CreateActivity);
                    NewActivityES = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityES\']", "Create Escalation", locator, CreateActivity);
                    NewActivityM = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityM\']", "Create Message", locator, CreateActivity);
                    NewActivityP = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityP\']", "Create Phone Call", locator, CreateActivity);
                    NewActivityW = new ToolBarButtonGrid("css=div#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb_menucmdAddActivit" +
                            "y li[data-cmd=\'NewActivity@NewActivityW\']", "Create Work Item", locator, CreateActivity);
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'Adjust" +
                            "Columns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'Export" +
                            "Excel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_ab_tlb div[data-cmd=\'PageFi" +
                            "rst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_ab_tlb div[data-cmd=\'PagePr" +
                            "ev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_ab_tlb div[data-cmd=\'PageNe" +
                            "xt\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_ab_tlb div[data-cmd=\'PageLa" +
                            "st\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t11_gridActivities_Activities_grid_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public PXTextEdit NoteID { get; }
                        ...
                        base(grid)
                {
                    Files = new FileColumnButton(null, "Files", grid.Locator, "Files");
                    Notes = new NoteColumnButton(null, "Notes", grid.Locator, "Notes");
                    IsCompleteIcon = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Complete Icon", grid.Locator, "IsCompleteIcon");
                    IsCompleteIcon.DataField = "IsCompleteIcon";
                    PriorityIcon = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Priority Icon", grid.Locator, "PriorityIcon");
                    PriorityIcon.DataField = "PriorityIcon";
                    CRReminder__ReminderIcon = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Reminder Icon", grid.Locator, "CRReminder__ReminderIcon");
                    CRReminder__ReminderIcon.DataField = "CRReminder__ReminderIcon";
                    ClassIcon = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Class Icon", grid.Locator, "ClassIcon");
                    ClassIcon.DataField = "ClassIcon";
                    ClassInfo = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Type", grid.Locator, "ClassInfo");
                    ClassInfo.DataField = "ClassInfo";
                    RefNoteID = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "RefNoteID", grid.Locator, "RefNoteID");
                    RefNoteID.DataField = "RefNoteID";
                    Subject = new Selector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "Summary", grid.Locator, "Subject");
                    Subject.DataField = "Subject";
                    UIStatus = new DropDown("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_ec", "Status", grid.Locator, "UIStatus");
                    ...
                    Released = new CheckBox("ctl00_phG_tab_t11_gridActivities_Activities_grid", "Released", grid.Locator, "Released");
                    Released.DataField = "Released";
                    StartDate = new DateSelector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_ed11", "Start Date", grid.Locator, "StartDate");
                    StartDate.DataField = "StartDate";
                    CreatedDateTime = new DateSelector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_ed12", "Created At", grid.Locator, "CreatedDateTime");
                    CreatedDateTime.DataField = "CreatedDateTime";
                    TimeSpent = new DropDown("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_ec", "Time Spent", grid.Locator, "TimeSpent");
                    ...
                    CreatedByID = new Selector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "CreatedByID", grid.Locator, "CreatedByID");
                    CreatedByID.DataField = "CreatedByID";
                    CreatedByID_Creator_Username = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Created By", grid.Locator, "CreatedByID_Creator_Username");
                    CreatedByID_Creator_Username.DataField = "CreatedByID_Creator_Username";
                    WorkgroupID = new Selector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "Workgroup", grid.Locator, "WorkgroupID");
                    WorkgroupID.DataField = "WorkgroupID";
                    OwnerID = new Selector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "Owner", grid.Locator, "OwnerID");
                    OwnerID.DataField = "OwnerID";
                    ProjectID = new Selector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "Project", grid.Locator, "ProjectID");
                    ProjectID.DataField = "ProjectID";
                    ProjectTaskID = new Selector("_ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "Project Task", grid.Locator, "ProjectTaskID");
                    ProjectTaskID.DataField = "ProjectTaskID";
                    Source = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "Related Entity Description", grid.Locator, "Source");
                    Source.DataField = "Source";
                    NoteID = new PXTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_grid_ei", "NoteID", grid.Locator, "NoteID");
        ...
        public class c_activities_lv0 : Container
        {
            ...
            public c_activities_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Es = new Selector("ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Ec = new DropDown("ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_ec", "Ec", locator, null);
                Em = new Selector("ctl00_phG_tab_t11_gridActivities_Activities_grid_lv0_em", "Em", locator, null);
                EmLabel = new Label(Em);
                DataMemberName = "Activities";
            }
        }
        ...
        public class c_activities_preview_activities_form : Container
        {
            ...
            public c_activities_preview_activities_form(string locator, string name) : 
                    base(locator, name)
            {
                Body = new RichTextEdit("ctl00_phG_tab_t11_gridActivities_Activities_form_edBody", "Body", locator, null);
        ...
        public class c_notificationsources_gridns : Grid<c_notificationsources_gridns.c_grid_row, c_notificationsources_gridns.c_grid_header>
        {
            ...
            public c_notificationsources_gridns(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t13_sp1_gridNS");
                DataMemberName = "NotificationSources";
                Buttons = new PxButtonCollection();
                FilterForm = new c_grid_filter("ctl00_phG_tab_t13_sp1_gridNS_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNS_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Button ContactIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "ContactIDEdit", "ctl00_phG_tab_t13_sp1_gridNS");
			...
			public PXNumberEdit SourceID { get; }
                ...
                public c_grid_row(c_notificationsources_gridns grid) : 
                        base(grid)
                {
                    Active = new CheckBox("_ctl00_phG_tab_t13_sp1_gridNS_lv0_chkActive", "Active", grid.Locator, "Active");
                    Active.DataField = "Active";
                    OverrideSource = new CheckBox("ctl00_phG_tab_t13_sp1_gridNS_ef", "Overridden", grid.Locator, "OverrideSource");
                    OverrideSource.DataField = "OverrideSource";
                    SetupID = new Selector("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edSetupID", "Mailing ID", grid.Locator, "SetupID");
                    SetupID.DataField = "SetupID";
                    NBranchID = new Selector("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edNBranchID", "Branch", grid.Locator, "NBranchID");
                    NBranchID.DataField = "NBranchID";
                    EMailAccountID = new Selector("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edEMailAccountID", "Email Account", grid.Locator, "EMailAccountID");
                    EMailAccountID.DataField = "EMailAccountID";
                    ReportID = new Selector("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edReportID", "Report", grid.Locator, "ReportID");
                    ReportID.DataField = "ReportID";
                    NotificationID = new Selector("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edNotificationID", "Notification Template", grid.Locator, "NotificationID");
                    NotificationID.DataField = "NotificationID";
                    Format = new DropDown("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edFormat", "Format", grid.Locator, "Format");
                    Format.DataField = "Format";
                    Format.Items.Add("H", "Html");
                    Format.Items.Add("E", "Excel");
                    Format.Items.Add("P", "PDF");
                    RecipientsBehavior = new DropDown("_ctl00_phG_tab_t13_sp1_gridNS_lv0_ec", "Recipients", grid.Locator, "RecipientsBehavior");
                    ...
                    SourceID = new PXNumberEdit("ctl00_phG_tab_t13_sp1_gridNS_en", "SourceID", grid.Locator, "SourceID");
        ...
        public class c_notificationsources_lv0 : Container
        {
            ...
            public c_notificationsources_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Format = new DropDown("ctl00_phG_tab_t13_sp1_gridNS_lv0_edFormat", "Format", locator, null);
                FormatLabel = new Label(Format);
                Format.DataField = "Format";
                Format.Items.Add("H", "Html");
                Format.Items.Add("E", "Excel");
                Format.Items.Add("P", "PDF");
                NBranchID = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_edNBranchID", "Branch", locator, null);
                NBranchIDLabel = new Label(NBranchID);
                NBranchID.DataField = "NBranchID";
                Active = new CheckBox("ctl00_phG_tab_t13_sp1_gridNS_lv0_chkActive", "Active", locator, null);
                ActiveLabel = new Label(Active);
                Active.DataField = "Active";
                SetupID = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_edSetupID", "Mailing ID", locator, null);
                SetupIDLabel = new Label(SetupID);
                SetupID.DataField = "SetupID";
                ReportID = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_edReportID", "Report", locator, null);
                ReportIDLabel = new Label(ReportID);
                ReportID.DataField = "ReportID";
                NotificationID = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_edNotificationID", "Notification Template", locator, null);
                NotificationIDLabel = new Label(NotificationID);
                NotificationID.DataField = "NotificationID";
                EMailAccountID = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_edEMailAccountID", "Email Account", locator, null);
                EMailAccountIDLabel = new Label(EMailAccountID);
                EMailAccountID.DataField = "EMailAccountID";
                Es = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ec = new DropDown("ctl00_phG_tab_t13_sp1_gridNS_lv0_ec", "Ec", locator, null);
                DataMemberName = "NotificationSources";
                Buttons = new PxButtonCollection();
            }
			...
			public Button ContactIDEdit { get; }
                ...
                {
                    ContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "ContactIDEdit", "ctl00_phG_tab_t13_sp1_gridNS_lv0");
                    ContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_notificationrecipients_gridnr : Grid<c_notificationrecipients_gridnr.c_grid_row, c_notificationrecipients_gridnr.c_grid_header>
        {
            ...
            public c_notificationrecipients_gridnr(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t13_sp1_gridNR");
                DataMemberName = "NotificationRecipients";
                Buttons = new PxButtonCollection();
                FilterForm = new c_grid_filter("ctl00_phG_tab_t13_sp1_gridNR_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t13_sp1_gridNR_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Button ContactIDEdit { get; }
                ...
                {
                    ContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "ContactIDEdit", "ctl00_phG_tab_t13_sp1_gridNR");
                    ContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
			...
			public PXNumberEdit NotificationID { get; }
                ...
                public c_grid_row(c_notificationrecipients_gridnr grid) : 
                        base(grid)
                {
                    Active = new CheckBox("ctl00_phG_tab_t13_sp1_gridNR_ef", "Active", grid.Locator, "Active");
                    Active.DataField = "Active";
                    ContactType = new DropDown("_ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactType", "Contact Type", grid.Locator, "ContactType");
                    ...
                    OriginalContactID = new PXNumberEdit("ctl00_phG_tab_t13_sp1_gridNR_en", "OriginalContactID", grid.Locator, "OriginalContactID");
                    OriginalContactID.DataField = "OriginalContactID";
                    ContactID = new Selector("_ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactID", "Contact ID", grid.Locator, "ContactID");
                    ContactID.DataField = "ContactID";
                    Email = new PXTextEdit("ctl00_phG_tab_t13_sp1_gridNR_ei", "Email", grid.Locator, "Email");
                    Email.DataField = "Email";
                    Format = new DropDown("_ctl00_phG_tab_t13_sp1_gridNR_lv0_ec", "Format", grid.Locator, "Format");
                    Format.DataField = "Format";
                    Format.Items.Add("H", "Html");
                    Format.Items.Add("E", "Excel");
                    Format.Items.Add("P", "PDF");
                    AddTo = new DropDown("_ctl00_phG_tab_t13_sp1_gridNR_lv0_ec", "Add To", grid.Locator, "AddTo");
                    AddTo.DataField = "AddTo";
                    AddTo.Items.Add("T", "To");
                    AddTo.Items.Add("C", "Cc");
                    AddTo.Items.Add("B", "Bcc");
                    NotificationID = new PXNumberEdit("ctl00_phG_tab_t13_sp1_gridNR_en", "NotificationID", grid.Locator, "NotificationID");
                    NotificationID.DataField = "NotificationID";
                }
            }
        ...
        public class c_notificationrecipients_lv0 : Container
        {
            ...
            public c_notificationrecipients_lv0(string locator, string name) : 
                    base(locator, name)
            {
                ContactType = new DropDown("ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactType", "Contact Type", locator, null);
                ...
                ContactType.Items.Add("E", "Employee");
                ContactType.Items.Add("C", "Contact");
                ContactID = new Selector("ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactID", "Contact ID", locator, null);
                ContactIDLabel = new Label(ContactID);
                ContactID.DataField = "ContactID";
                Es = new Selector("ctl00_phG_tab_t13_sp1_gridNR_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ec = new DropDown("ctl00_phG_tab_t13_sp1_gridNR_lv0_ec", "Ec", locator, null);
                DataMemberName = "NotificationRecipients";
                Buttons = new PxButtonCollection();
            }
			...
			public Button ContactIDEdit { get; }
                ...
                {
                    ContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t13_sp1_gridNR_lv0_edContactID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "ContactIDEdit", "ctl00_phG_tab_t13_sp1_gridNR_lv0");
                    ContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_childaccounts_gridchildaccounts : Grid<c_childaccounts_gridchildaccounts.c_grid_row, c_childaccounts_gridchildaccounts.c_grid_header>
        {
            ...
            public c_childaccounts_gridchildaccounts(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t9_gridChildAccounts");
                DataMemberName = "ChildAccounts";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t9_gridChildAccounts_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t9_gridChildAccounts_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Selector StatementCycleId { get; }
                ...
                public c_grid_row(c_childaccounts_gridchildaccounts grid) : 
                        base(grid)
                {
                    CustomerID = new Selector("_ctl00_phG_tab_t9_gridChildAccounts_lv0_edChildCustomerID", "Customer", grid.Locator, "CustomerID");
                    CustomerID.DataField = "CustomerID";
                    CustomerName = new PXTextEdit("ctl00_phG_tab_t9_gridChildAccounts_ei", "Customer Name", grid.Locator, "CustomerName");
                    CustomerName.DataField = "CustomerName";
                    BaseCuryID = new PXTextEdit("ctl00_phG_tab_t9_gridChildAccounts_ei", "Currency", grid.Locator, "BaseCuryID");
                    BaseCuryID.DataField = "BaseCuryID";
                    Balance = new PXNumberEdit("ctl00_phG_tab_t9_gridChildAccounts_en", "Balance", grid.Locator, "Balance");
                    Balance.DataField = "Balance";
                    SignedDepositsBalance = new PXNumberEdit("ctl00_phG_tab_t9_gridChildAccounts_en", "Prepayment Balance", grid.Locator, "SignedDepositsBalance");
                    SignedDepositsBalance.DataField = "SignedDepositsBalance";
                    UnreleasedBalance = new PXNumberEdit("ctl00_phG_tab_t9_gridChildAccounts_en", "Unreleased Balance", grid.Locator, "UnreleasedBalance");
                    UnreleasedBalance.DataField = "UnreleasedBalance";
                    OpenOrdersBalance = new PXNumberEdit("ctl00_phG_tab_t9_gridChildAccounts_en", "Open Orders Balance", grid.Locator, "OpenOrdersBalance");
                    OpenOrdersBalance.DataField = "OpenOrdersBalance";
                    OldInvoiceDate = new DateSelector("_ctl00_phG_tab_t9_gridChildAccounts_lv0_ed7", "First Due Date", grid.Locator, "OldInvoiceDate");
                    OldInvoiceDate.DataField = "OldInvoiceDate";
                    ConsolidateToParent = new CheckBox("ctl00_phG_tab_t9_gridChildAccounts", "Consolidate Balance", grid.Locator, "ConsolidateToParent");
                    ConsolidateToParent.DataField = "ConsolidateToParent";
                    ConsolidateStatements = new CheckBox("ctl00_phG_tab_t9_gridChildAccounts", "Consolidate Statements", grid.Locator, "ConsolidateStatements");
                    ConsolidateStatements.DataField = "ConsolidateStatements";
                    SharedCreditPolicy = new CheckBox("ctl00_phG_tab_t9_gridChildAccounts", "Share Credit Policy", grid.Locator, "SharedCreditPolicy");
                    SharedCreditPolicy.DataField = "SharedCreditPolicy";
                    StatementCycleId = new Selector("_ctl00_phG_tab_t9_gridChildAccounts_lv0_es", "Statement Cycle", grid.Locator, "StatementCycleId");
                    StatementCycleId.DataField = "StatementCycleId";
                }
            }
        ...
        public class c_childaccounts_lv0 : Container
        {
            ...
            public c_childaccounts_lv0(string locator, string name) : 
                    base(locator, name)
            {
                CustomerID = new Selector("ctl00_phG_tab_t9_gridChildAccounts_lv0_edChildCustomerID", "Customer", locator, null);
                CustomerIDLabel = new Label(CustomerID);
                CustomerID.DataField = "CustomerID";
                Es = new Selector("ctl00_phG_tab_t9_gridChildAccounts_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_tab_t9_gridChildAccounts_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                DataMemberName = "ChildAccounts";
                Buttons = new PxButtonCollection();
            }
			...
			public Button CustomerIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    CustomerIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t9_gridChildAccounts_lv0_edChildCustomerID\'] div[class=" +
                            "\'editBtnCont\'] > div > div", "CustomerIDEdit", "ctl00_phG_tab_t9_gridChildAccounts_lv0");
        ...
        public class c_paymentmethods_grdpaymentmethods : Grid<c_paymentmethods_grdpaymentmethods.c_grid_row, c_paymentmethods_grdpaymentmethods.c_grid_header>
        {
            ...
            public c_paymentmethods_grdpaymentmethods(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t6_grdPaymentMethods");
                DataMemberName = "PaymentMethods";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t6_grdPaymentMethods_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    AddPaymentMethod = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_at_tlb div[data-cmd=\'AddPaymentMethod\']", "Add Payment Method", locator, null);
                    ViewPaymentMethod = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_at_tlb div[data-cmd=\'cmdViewPaymentMethod" +
                            "\']", "View Payment Method", locator, null);
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t6_grdPaymentMethods_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public PXNumberEdit PMInstanceID { get; }
                ...
                public c_grid_row(c_paymentmethods_grdpaymentmethods grid) : 
                        base(grid)
                {
                    IsDefault = new CheckBox("ctl00_phG_tab_t6_grdPaymentMethods_ef", "Is Default", grid.Locator, "IsDefault");
                    IsDefault.DataField = "IsDefault";
                    PaymentMethodID = new PXTextEdit("ctl00_phG_tab_t6_grdPaymentMethods_ei", "Payment Method", grid.Locator, "PaymentMethodID");
                    PaymentMethodID.DataField = "PaymentMethodID";
                    Descr = new InputLocalizable("ctl00_phG_tab_t6_grdPaymentMethods_ei", "Description", grid.Locator, "Descr");
                    Descr.DataField = "Descr";
                    CashAccountID = new Selector("_ctl00_phG_tab_t6_grdPaymentMethods_lv0_es", "Cash Account", grid.Locator, "CashAccountID");
                    CashAccountID.DataField = "CashAccountID";
                    IsActive = new CheckBox("ctl00_phG_tab_t6_grdPaymentMethods", "Active", grid.Locator, "IsActive");
                    IsActive.DataField = "IsActive";
                    IsCustomerPaymentMethod = new CheckBox("ctl00_phG_tab_t6_grdPaymentMethods", "Override", grid.Locator, "IsCustomerPaymentMethod");
                    IsCustomerPaymentMethod.DataField = "IsCustomerPaymentMethod";
                    PMInstanceID = new PXNumberEdit("ctl00_phG_tab_t6_grdPaymentMethods_en", "PMInstanceID", grid.Locator, "PMInstanceID");
        ...
        public class c_paymentmethods_lv0 : Container
        {
            ...
            public c_paymentmethods_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Es = new Selector("ctl00_phG_tab_t6_grdPaymentMethods_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                DataMemberName = "PaymentMethods";
            }
        }
        ...
        public class c_compliancedocuments_grdcompliancedocuments : Grid<c_compliancedocuments_grdcompliancedocuments.c_grid_row, c_compliancedocuments_grdcompliancedocuments.c_grid_header>
        {
            ...
            public c_compliancedocuments_grdcompliancedocuments(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t15_grdComplianceDocuments");
                DataMemberName = "ComplianceDocuments";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t15_grdComplianceDocuments_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_at_tlb div[data-cmd=\'AdjustColumns\'" +
                            "]", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t15_grdComplianceDocuments_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Selector DocumentTypeValue { get; }
                ...
                public c_grid_row(c_compliancedocuments_grdcompliancedocuments grid) : 
                        base(grid)
                {
                    ExpirationDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Expiration Date", grid.Locator, "ExpirationDate");
                    ExpirationDate.DataField = "ExpirationDate";
                    DocumentType = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Document Type", grid.Locator, "DocumentType");
                    DocumentType.DataField = "DocumentType";
                    CreationDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Creation Date", grid.Locator, "CreationDate");
                    CreationDate.DataField = "CreationDate";
                    Status = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Status", grid.Locator, "Status");
                    Status.DataField = "Status";
                    Required = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Required", grid.Locator, "Required");
                    Required.DataField = "Required";
                    Received = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Received", grid.Locator, "Received");
                    Received.DataField = "Received";
                    ReceivedDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Received Date", grid.Locator, "ReceivedDate");
                    ReceivedDate.DataField = "ReceivedDate";
                    IsProcessed = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Is Processed", grid.Locator, "IsProcessed");
                    IsProcessed.DataField = "IsProcessed";
                    IsVoided = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Is Voided", grid.Locator, "IsVoided");
                    IsVoided.DataField = "IsVoided";
                    IsCreatedAutomatically = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Is Created Automatically", grid.Locator, "IsCreatedAutomatically");
                    IsCreatedAutomatically.DataField = "IsCreatedAutomatically";
                    SentDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Sent Date", grid.Locator, "SentDate");
                    SentDate.DataField = "SentDate";
                    ProjectID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Project ID", grid.Locator, "ProjectID");
                    ProjectID.DataField = "ProjectID";
                    CostTaskID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edCostTaskID", "Cost Task ID", grid.Locator, "CostTaskID");
                    CostTaskID.DataField = "CostTaskID";
                    RevenueTaskID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edRevenueTaskID", "Revenue Task ID", grid.Locator, "RevenueTaskID");
                    RevenueTaskID.DataField = "RevenueTaskID";
                    CostCodeID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edCostCode2", "Cost Code ID", grid.Locator, "CostCodeID");
                    CostCodeID.DataField = "CostCodeID";
                    VendorID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Vendor ID", grid.Locator, "VendorID");
                    VendorID.DataField = "VendorID";
                    VendorName = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Vendor Name", grid.Locator, "VendorName");
                    VendorName.DataField = "VendorName";
                    BillID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edBillID", "Bill ID", grid.Locator, "BillID");
                    BillID.DataField = "BillID";
                    BillAmount = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Bill Amount", grid.Locator, "BillAmount");
                    BillAmount.DataField = "BillAmount";
                    CustomerID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Customer ID", grid.Locator, "CustomerID");
                    CustomerID.DataField = "CustomerID";
                    ApCheckID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edApCheckID", "Ap Check ID", grid.Locator, "ApCheckID");
                    ApCheckID.DataField = "ApCheckID";
                    CheckNumber = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Check Number", grid.Locator, "CheckNumber");
                    CheckNumber.DataField = "CheckNumber";
                    ArPaymentID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edArPaymentID", "Ar Payment ID", grid.Locator, "ArPaymentID");
                    ArPaymentID.DataField = "ArPaymentID";
                    CertificateNumber = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Certificate Number", grid.Locator, "CertificateNumber");
                    CertificateNumber.DataField = "CertificateNumber";
                    CreatedByID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Created By ID", grid.Locator, "CreatedByID");
                    CreatedByID.DataField = "CreatedByID";
                    CustomerName = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Customer Name", grid.Locator, "CustomerName");
                    CustomerName.DataField = "CustomerName";
                    AccountID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Account ID", grid.Locator, "AccountID");
                    AccountID.DataField = "AccountID";
                    DateIssued = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Date Issued", grid.Locator, "DateIssued");
                    DateIssued.DataField = "DateIssued";
                    EffectiveDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Effective Date", grid.Locator, "EffectiveDate");
                    EffectiveDate.DataField = "EffectiveDate";
                    InsuranceCompany = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Insurance Company", grid.Locator, "InsuranceCompany");
                    InsuranceCompany.DataField = "InsuranceCompany";
                    InvoiceAmount = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Invoice Amount", grid.Locator, "InvoiceAmount");
                    InvoiceAmount.DataField = "InvoiceAmount";
                    InvoiceID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edInvoiceID", "Invoice ID", grid.Locator, "InvoiceID");
                    InvoiceID.DataField = "InvoiceID";
                    IsExpired = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Is Expired", grid.Locator, "IsExpired");
                    IsExpired.DataField = "IsExpired";
                    IsRequiredJointCheck = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Is Required Joint Check", grid.Locator, "IsRequiredJointCheck");
                    IsRequiredJointCheck.DataField = "IsRequiredJointCheck";
                    JointAmount = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Joint Amount", grid.Locator, "JointAmount");
                    JointAmount.DataField = "JointAmount";
                    JointRelease = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Joint Release", grid.Locator, "JointRelease");
                    JointRelease.DataField = "JointRelease";
                    JointReleaseReceived = new CheckBox("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Joint Release Received", grid.Locator, "JointReleaseReceived");
                    JointReleaseReceived.DataField = "JointReleaseReceived";
                    JointVendorInternalId = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Joint Vendor Internal Id", grid.Locator, "JointVendorInternalId");
                    JointVendorInternalId.DataField = "JointVendorInternalId";
                    JointVendorExternalName = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Joint Vendor External Name", grid.Locator, "JointVendorExternalName");
                    JointVendorExternalName.DataField = "JointVendorExternalName";
                    LastModifiedByID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Last Modified By ID", grid.Locator, "LastModifiedByID");
                    LastModifiedByID.DataField = "LastModifiedByID";
                    LienWaiverAmount = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Lien Waiver Amount", grid.Locator, "LienWaiverAmount");
                    LienWaiverAmount.DataField = "LienWaiverAmount";
                    Limit = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Limit", grid.Locator, "Limit");
                    Limit.DataField = "Limit";
                    MethodSent = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Method Sent", grid.Locator, "MethodSent");
                    MethodSent.DataField = "MethodSent";
                    PaymentDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Payment Date", grid.Locator, "PaymentDate");
                    PaymentDate.DataField = "PaymentDate";
                    ArPaymentMethodID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Ar Payment Method ID", grid.Locator, "ArPaymentMethodID");
                    ArPaymentMethodID.DataField = "ArPaymentMethodID";
                    ApPaymentMethodID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Ap Payment Method ID", grid.Locator, "ApPaymentMethodID");
                    ApPaymentMethodID.DataField = "ApPaymentMethodID";
                    Policy = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Policy", grid.Locator, "Policy");
                    Policy.DataField = "Policy";
                    ProjectTransactionID = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edProjectTransactionID", "Project Transaction ID", grid.Locator, "ProjectTransactionID");
                    ProjectTransactionID.DataField = "ProjectTransactionID";
                    PurchaseOrder = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edPurchaseOrder", "Purchase Order", grid.Locator, "PurchaseOrder");
                    PurchaseOrder.DataField = "PurchaseOrder";
                    PurchaseOrderLineItem = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edPurchaseOrderLineItem", "Purchase Order Line Item", grid.Locator, "PurchaseOrderLineItem");
                    PurchaseOrderLineItem.DataField = "PurchaseOrderLineItem";
                    Subcontract = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edSubcontract", "Subcontract", grid.Locator, "Subcontract");
                    Subcontract.DataField = "Subcontract";
                    SubcontractLineItem = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edSubcontractLineItem", "Subcontract Line Item", grid.Locator, "SubcontractLineItem");
                    SubcontractLineItem.DataField = "SubcontractLineItem";
                    ChangeOrderNumber = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edChangeOrderNumber", "Change Order Number", grid.Locator, "ChangeOrderNumber");
                    ChangeOrderNumber.DataField = "ChangeOrderNumber";
                    ReceiptDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Receipt Date", grid.Locator, "ReceiptDate");
                    ReceiptDate.DataField = "ReceiptDate";
                    ReceiveDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Receive Date", grid.Locator, "ReceiveDate");
                    ReceiveDate.DataField = "ReceiveDate";
                    ReceivedBy = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Received By", grid.Locator, "ReceivedBy");
                    ReceivedBy.DataField = "ReceivedBy";
                    SecondaryVendorID = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Secondary Vendor ID", grid.Locator, "SecondaryVendorID");
                    SecondaryVendorID.DataField = "SecondaryVendorID";
                    SecondaryVendorName = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Secondary Vendor Name", grid.Locator, "SecondaryVendorName");
                    SecondaryVendorName.DataField = "SecondaryVendorName";
                    SourceType = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Source Type", grid.Locator, "SourceType");
                    SourceType.DataField = "SourceType";
                    SponsorOrganization = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Sponsor Organization", grid.Locator, "SponsorOrganization");
                    SponsorOrganization.DataField = "SponsorOrganization";
                    ThroughDate = new PXTextEdit("ctl00_phG_tab_t15_grdComplianceDocuments_ei", "Through Date", grid.Locator, "ThroughDate");
                    ThroughDate.DataField = "ThroughDate";
                    DocumentTypeValue = new Selector("_ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edDocumentTypeValue", "Document Type Value", grid.Locator, "DocumentTypeValue");
        ...
        public class c_compliancedocuments_lv0 : Container
        {
            ...
            public c_compliancedocuments_lv0(string locator, string name) : 
                    base(locator, name)
            {
                CostCodeID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edCostCode2", "Cost Code ID", locator, null);
                CostCodeIDLabel = new Label(CostCodeID);
                CostCodeID.DataField = "CostCodeID";
                DocumentTypeValue = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edDocumentTypeValue", "Document Type Value", locator, null);
                DocumentTypeValueLabel = new Label(DocumentTypeValue);
                DocumentTypeValue.DataField = "DocumentTypeValue";
                BillID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edBillID", "Bill ID", locator, null);
                BillIDLabel = new Label(BillID);
                BillID.DataField = "BillID";
                InvoiceID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edInvoiceID", "Invoice ID", locator, null);
                InvoiceIDLabel = new Label(InvoiceID);
                InvoiceID.DataField = "InvoiceID";
                ApCheckID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edApCheckID", "Ap Check ID", locator, null);
                ApCheckIDLabel = new Label(ApCheckID);
                ApCheckID.DataField = "ApCheckID";
                ArPaymentID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edArPaymentID", "Ar Payment ID", locator, null);
                ArPaymentIDLabel = new Label(ArPaymentID);
                ArPaymentID.DataField = "ArPaymentID";
                ProjectTransactionID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edProjectTransactionID", "Project Transaction ID", locator, null);
                ProjectTransactionIDLabel = new Label(ProjectTransactionID);
                ProjectTransactionID.DataField = "ProjectTransactionID";
                PurchaseOrder = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edPurchaseOrder", "Purchase Order", locator, null);
                PurchaseOrderLabel = new Label(PurchaseOrder);
                PurchaseOrder.DataField = "PurchaseOrder";
                PurchaseOrderLineItem = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edPurchaseOrderLineItem", "Purchase Order Line Item", locator, null);
                PurchaseOrderLineItemLabel = new Label(PurchaseOrderLineItem);
                PurchaseOrderLineItem.DataField = "PurchaseOrderLineItem";
                Subcontract = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edSubcontract", "Subcontract", locator, null);
                SubcontractLabel = new Label(Subcontract);
                Subcontract.DataField = "Subcontract";
                SubcontractLineItem = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edSubcontractLineItem", "Subcontract Line Item", locator, null);
                SubcontractLineItemLabel = new Label(SubcontractLineItem);
                SubcontractLineItem.DataField = "SubcontractLineItem";
                ChangeOrderNumber = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edChangeOrderNumber", "Change Order Number", locator, null);
                ChangeOrderNumberLabel = new Label(ChangeOrderNumber);
                ChangeOrderNumber.DataField = "ChangeOrderNumber";
                CostTaskID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edCostTaskID", "Cost Task ID", locator, null);
                CostTaskIDLabel = new Label(CostTaskID);
                CostTaskID.DataField = "CostTaskID";
                RevenueTaskID = new Selector("ctl00_phG_tab_t15_grdComplianceDocuments_lv0_edRevenueTaskID", "Revenue Task ID", locator, null);
        ...
        public class c_customerbillingcycles_gridbillingcycles : Grid<c_customerbillingcycles_gridbillingcycles.c_grid_row, c_customerbillingcycles_gridbillingcycles.c_grid_header>
        {
            ...
            public c_customerbillingcycles_gridbillingcycles(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t14_gridBillingCycles");
                DataMemberName = "CustomerBillingCycles";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t14_gridBillingCycles_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_gridBillingCycles_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public PXTextEdit MonthlyFrequency { get; }
                ...
                public c_grid_row(c_customerbillingcycles_gridbillingcycles grid) : 
                        base(grid)
                {
                    SrvOrdType = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Srv Ord Type", grid.Locator, "SrvOrdType");
                    SrvOrdType.DataField = "SrvOrdType";
                    BillingCycleID = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Billing Cycle ID", grid.Locator, "BillingCycleID");
                    BillingCycleID.DataField = "BillingCycleID";
                    SendInvoicesTo = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Send Invoices To", grid.Locator, "SendInvoicesTo");
                    SendInvoicesTo.DataField = "SendInvoicesTo";
                    BillShipmentSource = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Bill Shipment Source", grid.Locator, "BillShipmentSource");
                    BillShipmentSource.DataField = "BillShipmentSource";
                    FrequencyType = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Frequency Type", grid.Locator, "FrequencyType");
                    FrequencyType.DataField = "FrequencyType";
                    WeeklyFrequency = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Weekly Frequency", grid.Locator, "WeeklyFrequency");
                    WeeklyFrequency.DataField = "WeeklyFrequency";
                    MonthlyFrequency = new PXTextEdit("ctl00_phG_tab_t14_gridBillingCycles_ei", "Monthly Frequency", grid.Locator, "MonthlyFrequency");
